...
/**
 * brooklin cluster相关转换
 * @author liuxinyuan@163.com
 * @date 2019/3/15
 */
public class BrooklinClusterModelConverter {
    ...
    public static BrooklinClusterDO convert2ClusterDO(BrooklinClusterDTO reqObj) {
        BrooklinClusterDO clusterDO = new BrooklinClusterDO();
